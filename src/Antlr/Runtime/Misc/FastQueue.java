...
public class FastQueue<T> {
  ...
  public java.lang.Integer getRange() {
    try {
      java.lang.Integer res = javonetHandle.get("Range");
      if (res == null) return 0;
      return res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public T get_Item(java.lang.Integer i, Class<?> returnType) {
    try {
  ...
  public FastQueue(Class<?> T) {
    try {
      javonetHandle =
          Javonet.getType("Antlr.Runtime.Misc.FastQueue`1", getReturnObjectName(T)).create();
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public FastQueue(NObject handle) {
  ...
  public void Enqueue(T o) {
    try {
      javonetHandle.invoke("Enqueue", o);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
