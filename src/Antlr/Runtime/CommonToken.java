...
public class CommonToken implements IToken {
  ...
  public CommonToken() {
    try {
      javonetHandle = Javonet.New("Antlr.Runtime.CommonToken");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public CommonToken(java.lang.Integer type) {
    try {
      javonetHandle = Javonet.New("Antlr.Runtime.CommonToken", type);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public CommonToken(
    ...
    try {
      javonetHandle = Javonet.New("Antlr.Runtime.CommonToken", input, type, channel, start, stop);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public CommonToken(java.lang.Integer type, java.lang.String text) {
    try {
      javonetHandle = Javonet.New("Antlr.Runtime.CommonToken", type, text);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public CommonToken(IToken oldToken) {
    try {
      javonetHandle = Javonet.New("Antlr.Runtime.CommonToken", oldToken);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public CommonToken(NObject handle) {
